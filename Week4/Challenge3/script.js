...
function show(button_element) {
    ...
    */
    ...
    // var taName = facts.button_element.id;
    var funFact = facts[button_element.id];
    var taBox = document.getElementById("ta-fun-fact");
    taBox.innerText = funFact;
    ...
    var img = document.getElementById("ta-photo");
    img.setAttribute("src", "photos/" + button_element.id +".jpg");
    ...
    var buttons = document.querySelectorAll("#left-child button");
